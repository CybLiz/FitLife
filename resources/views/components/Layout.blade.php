                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nav-link href="/home" aria-current="page" :active="request()->is('home')">Home</x-nav-link>
                                <x-nav-link href="/booking" :active="request()->is('booking')">Booking</x-nav-link>
                                <x-nav-link href="/reservations" :active="request()->is('resevation')">My reservations</x-nav-link>
